...
function getVideosForDirector(director) {

  const videos = {
    LarsPetersdorff: [
      { url: "https://example.com/video1", title: "Video Title 1" },
      { url: "https://example.com/video2", title: "Video Title 2" },
      { url: "https://example.com/video3", title: "Video Title 3" },
      { url: "https://example.com/video4", title: "Video Title 4" },
      { url: "https://example.com/video5", title: "Video Title 5" },
    ],
    PabloVilla: [
      {
  ...
  return videos[director] || [];
}


const DirectorPortfolio = ({ director }) => {
  // Placeholder for videos information. You'd typically fetch this or define it elsewhere.
  const navigate = useNavigate();
  const videos = getVideosForDirector(director); // Implement this function based on your data structure
