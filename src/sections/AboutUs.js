  ...
  <div className="about-us" id="aboutus">
    <div className="container">
      <div id="title-row">
        ...
        <div id="text-carousel" class="text-carousel">
      ...
      <p>From initial concept to final delivery, our team crafts stunning visual content tailored for brands and agencies. Our expertise spans a diverse array of fields, encompassing both videography and photography, ensuring we capture the essence of your message. 
        <br></br><br></br>Through a collaborative approach, we work closely with our clients, offering our expertise to guide them toward the most effective strategies for their projects. Select from our talented directors to bring your vision to life with precision and creativity.</p>
    </div>
  </div>
);
